...
public class SM_DownloadDB {
    ...
    private synchronized void smtbls() {
        ...
        try {
            ...
            while (rs.next()) {
                tbls += rs.getString("Tables_in_sm") + ",";
            }
            try {
                rs.close();
            } catch (Exception e) {
            ...
            if (z == null || z.trim().length() == 0) {
                ...
                try {
                    ...
                    try {
                        ...
                        String pathbk = SM_Strngs.fl + "\\" + z + ".csv";
    ...
    private synchronized void process_file(String lnk_dwnld2) {
        ...
        try {
            ...
            SM_AppZipbs appZip = new SM_AppZipbs();
            appZip.zipIt(zipflnm, SM_Strngs.pwd2, SM_Strngs.fl);
            dirmng.cpybckflToCFloldr(cssn.getPathIrprt());
            r += lang.lng(current_lang, "the_file_was_created") + "!\n";
            try {
                prt = getIpAddressAndPort();
            } catch (MalformedObjectNameException ex) {
                Logger.getLogger(SM_DownloadDB.class.getName()).log(Level.SEVERE, null, ex);
            } catch (NullPointerException ex) {
                Logger.getLogger(SM_DownloadDB.class.getName()).log(Level.SEVERE, null, ex);
            } catch (UnknownHostException ex) {
                Logger.getLogger(SM_DownloadDB.class.getName()).log(Level.SEVERE, null, ex);
            }
            r = "<span style='color: green;'>" + lang.lng(current_lang, "click_m") + " <a href='http://" + lnk_dwnld2 + ":" + prt + "/SM/BCKUPS/" 
            ...
            for (; n.hasMoreElements();) {
                ...
                for (; a.hasMoreElements();) {
                    ...
                    r = "Clique <a href='http://" + lnk_dwnld + ":" + prt + "/SM/BCKUPS/" + zp + "'  style='text-decoration: none;'>aqui</a> para baixar o ficheiro!\n<br>";
