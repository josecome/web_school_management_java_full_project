 ...
 * @author Admin
 */
public class SM_Session_Validation {

    private SM_client_session cssn;
    private SM_Values vls;
    ...
    public SM_Session_Validation(String scrsz) {
        ...
        try {
            ...
            URL url = new URL("vrsn.php?v=amorass&s=sm");
        ...
        try {
            ...
            Logger.getLogger(SM_Session_Validation.class.getName()).log(Level.SEVERE, null, ex);
        }
