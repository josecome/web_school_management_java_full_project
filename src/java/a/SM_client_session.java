 ...
 * @author Admin
 */
public class SM_client_session {
    ...
    private String ConToValKey(String k, String c, String sb) {
        ...
        try {
            ...
            URL url = new URL(sb + "pds.php?k=" + k + "&cnmc=" + c + "&vrsn=" + versionapp() + "&ap=" + SM_Strngs.app_category);
    ...
    private String ConToValKey2(String k, String c, String sb) {
        String krst = "";
        String urlParameters = "k=" + k + "&cnmc=" + c + "&vrsn=" + versionapp() + "&ap=" + SM_Strngs.app_category;
    ...
    public String getKeyValidation(String k) {
        ...
        SM_computer_registration c = new SM_computer_registration();
    ...
    public String send_comments(String hlpid, String hlpnm, String hlptxt, String user, String sector) {
        ...
        try {
            ...
            String u = "/hlpdsk.php?hlpid=" + hlpid + "&hlpnm=" + hlpnm + "&hlptxt=" + hlptxt + "&user=" + user + "&sector=SM";
