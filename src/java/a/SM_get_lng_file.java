 ...
 * @author Admin
 */
public class SM_get_lng_file {

    public String[][] getlngs() throws IOException {
        String[][] v = new String[800][10];
        URL path = SM_get_lng_file.class.getResource("SM_languages.csv");
        ...
        try (FileInputStream fstream = new FileInputStream(pthfl + "\\SM_languages.csv")) {
