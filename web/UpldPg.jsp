    ...
    <body oncontextmenu="return false">
        ...
        <%
            ...
            if (Lb != null && Lb.getStatus()) {
                ...
                String filePath = "" +cssn.getPathIrprt() + "\\webapps\\SM\\TEMPPATH\\";
                        ...
                        try {
                            ...
                            while (i.hasNext()) {
                                ...
                                if (!fi.isFormField()) {
                                    ...
                                    fileName = fi.getName();
                                    /*if(fileName.equalsIgnoreCase("smdump.zip")){
                                       out.println("<span style='color: red;'>Antes de caregar o ficheiro, renomeie o nome para 'smdump.zip'</span>");
                                       out.close();
                                       return;
                                    }*/
                            ...
                            SM_RestoreDB rbd = new SM_RestoreDB(fileName);
                            rbd.processrstr();
