        ...
        <%
            ...
            if (Lb != null && Lb.getStatus()) {
                ...
                try {
                    ...
                    String qry = "select mthly_payments.id as id, enrolled_students.student_name as nome,enrolled_students.course_id as curso, mthly_payments.id as id,"
                            + "mthly_payments.student_id as cod_est,mthly_payments.month_nmb,mthly_payments.amount_to_pay as vd,"
                            + "mthly_payments.amount_paid as vp,mthly_payments.ref_payment as ref,enrolled_students.course_level as nivel,"
                            ...
                            + " where mthly_payments.student_id = " + cod + " and mthly_payments.ref_payment = '" + rf + "'";
                ...
                if (y > 1) {
                    ...
                    try {
                        ...
                        String reportFileName = "recibo_pagamento.jrxml";
                        ...
                        prts.put("vp", vp);
                        prts.put("ref", ref);
                        prts.put("talao", talao);
                        prts.put("banco", banco);
                        prts.put("curso", curso);
                        prts.put("cod_est", cod_est);
                        prts.put("nivel", nivel);
                        prts.put("lvl", lvl);
                        prts.put("pag_nr", pag_nr);
